...
- Commonly used to implement server side rendering for css-in-js libraries like [styled-components](https://github.com/zeit/next.js/tree/canary/examples/data-fetch/with-styled-components), [glamorous](https://github.com/zeit/next.js/tree/canary/examples/data-fetch/with-glamorous) or [emotion](https://github.com/zeit/next.js/tree/canary/examples/with-emotion). [styled-jsx](https://github.com/zeit/styled-jsx) is included with Next.js by default.
...
Yes! Here's an example with [Apollo](https://github.com/zeit/next.js/tree/canary/examples/data-fetch/with-apollo).

#### Can I use it with Redux?

Yes! Here's an [example](https://github.com/zeit/next.js/tree/canary/examples/data-fetch/with-redux)
